	...
	<div class="main-w3layouts wrapper">
		<div class="main-agileinfo">
			<div class="agileits-top">
                ...
                <a href='ViewEvents.php'><font color="#1a1aff"></a><br></font>
                ...
                <input type="text" class="user" name="Empname" value="<?php echo $Fname." ".$Lname;  ?>" readonly><br>
				        <input type="text" class="course" id='course' name="course" value="<?php echo $course  ?>" readonly><br>
                <input type="text" class="yr" id='yr' name="yr" value="<?php echo $yr  ?>" readonly><br>
