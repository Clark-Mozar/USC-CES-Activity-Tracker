...
if(isset($_GET['code'])){ 
    ...
    if(!empty($event_id)){ 
        ...
        $sqlQ = "SELECT * FROM tblevent WHERE event_id = ?"; 
        ...
        if(!empty($eventData)){ 
            ...
            $event_datetime = array( 
                'start_date' => $eventData['date_start'], 
                'end_date' => $eventData['date_end'], 
                'start_time' => $eventData['timestart'], 
                'end_time' => $eventData['timeend'] 
            ); 
            ...
            if(!empty($access_token)){ 
                try { 
                    ...
                    if($google_event_id){ 
                        ...
                        $sqlQ = "UPDATE tblevent SET google_calendar_event_id=? WHERE event_id=?"; 
                        $stmt = $db->prepare($sqlQ); 
    ...
    // header("Location: http://uscces.great-site.net/MainPage.php?pageid=Home"); 
