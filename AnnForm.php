	...
	<div class="main-w3layouts wrapper">
		<div class="main-agileinfo">
			<div class="agileits-top">
                ...
                <form action="Announcement.php" method="POST" enctype="multipart/form-data" class="frmevents">
                <a href='ViewAnnouncement.php'><font color="#ff9900">View Announcement</a><br></font>
                ...
                <input type="text" class="user" name="Empname" value="<?php echo $Fname." ".$Lname;  ?>" readonly><br>
				        <input type="text" class="title" id='ann_name' name="ann_name" placeholder="Enter Announcement" required><br>
				  <textarea placeholder="Type announcement details" id="details" name="details" rows="10" cols="30"></textarea><br>
          <select name="course">
      ...
      <br>
			    ...
			    <button class="buttonsub" type="submit" name="submit">Post Announcement</button><br>
